...
public class GradleConfig {
  ...
  /**
   * Constructor for GradleConfig.
   */
  public GradleConfig(String gradleHome, String userHome, Boolean wrapperEnabled, String version,
      @NonNull String jvmArguments, @NonNull String javaExtensionVersion) {
